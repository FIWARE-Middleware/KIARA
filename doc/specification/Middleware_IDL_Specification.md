...
The `<scoped_name\>` in `<simple_type_spec>` must be a previously defined type introduced by a type declaration(`<type_dcl>` - see section [*Type Declaration*](#type-declaration)).
