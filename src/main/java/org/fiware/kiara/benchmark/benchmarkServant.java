 ...
 *
 */
public abstract class benchmarkServant implements Servant, benchmark {
    ...
    public TransportMessage process(Serializer ser, TransportMessage message, Transport transport, Object messageId, BinaryInputStream bis) {
        ...
        try {
            ...
            if (operation.equals("sendMarketData")) {
                MarketData marketData = null;
                try {
                    marketData = serImpl.deserialize(bis, "", MarketData.class);
                ...
                MarketData ret = sendMarketData(marketData);
            ...
            if (operation.equals("sendQuoteRequest")) {
                QuoteRequest quoteRequest = null;
                try {
                    quoteRequest = serImpl.deserialize(bis, "", QuoteRequest.class);
                } catch (InstantiationException e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                } catch (IllegalAccessException e) {
                ...
                QuoteRequest ret = sendQuoteRequest(quoteRequest);
                // Serialize return code (0 = OK)
                serImpl.serializeUI32(retBuffer, "", 0);
                // Serialize return type
                serImpl.serialize(retBuffer, "", ret);
