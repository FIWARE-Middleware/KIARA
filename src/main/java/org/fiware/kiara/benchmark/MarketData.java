...
/**
 * Class definition for the user defined type MarketData.
 *
...
public class MarketData implements Serializable {
    ...
    private List<MarketDataEntry> mdEntries;

    /*
     *      Attribute Serializers
     */
        private static final org.fiware.kiara.serialization.impl.Serializer<List<MarketDataEntry>> s_mdEntries =
            new ListAsSequenceSerializer<>(new ObjectSerializer<>(MarketDataEntry.class));
    /*
     *	Default constructor
     */
    ...
    /*
     * This method serializes a MarketData.
     *
    ...
    public void serialize(SerializerImpl impl, BinaryOutputStream message, String name) throws IOException {
        ...
        impl.serializeUI32(message, name, this.tradeDate);
        s_mdEntries.write(impl, message, name, this.mdEntries);
    }

    /*
     * This method deserializes a MarketData.
     *
    ...
    public void deserialize(SerializerImpl impl, BinaryInputStream message, String name) throws IOException {
        ...
        this.tradeDate = impl.deserializeUI32(message, name);
        this.mdEntries = s_mdEntries.read(impl, message, name);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof MarketData) {
            ...
            comparison = comparison && (this.isEcho == ((MarketData) other).isEcho);

            comparison = comparison && (this.counter == ((MarketData) other).counter);

            comparison = comparison && (this.securityID == ((MarketData) other).securityID);

            comparison = comparison && (this.applVersionID == ((MarketData) other).applVersionID);

            comparison = comparison && (this.messageType == ((MarketData) other).messageType);

            comparison = comparison && (this.senderCompID == ((MarketData) other).senderCompID);

            comparison = comparison && (this.msgSeqNum == ((MarketData) other).msgSeqNum);

            comparison = comparison && (this.sendingTime == ((MarketData) other).sendingTime);

            comparison = comparison && (this.tradeDate == ((MarketData) other).tradeDate);

            comparison = comparison && this.mdEntries.equals(((MarketData) other).mdEntries);
    ...
    /*
     * Method to get the attribute tradeDate.
     */
    ...
    /*
     * Method to set the attribute tradeDate.
     */
    ...
    /*
     * Method to get the attribute mdEntries.
     */
    ...
    /*
     * Method to set the attribute mdEntries.
     */
    ...
    @Override
    public int hashCode() {
        return Objects.hash(this.isEcho, this.counter, this.securityID, this.applVersionID, this.messageType, this.senderCompID, this.msgSeqNum, this.sendingTime, this.tradeDate, this.mdEntries);
    }
}
