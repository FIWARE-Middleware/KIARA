 ...
 *
 */
class benchmarkProxy implements benchmarkClient {

    public static final String serviceName = "benchmark";

	public benchmarkProxy(Serializer ser, Transport transport) {
	...
	public MarketData sendMarketData(/*in*/ MarketData marketData) {
		if (m_ser != null && m_transport != null) {
			...
			try {
	            ...
	            m_ser.serializeService(bos, "benchmark");
	            m_ser.serializeOperation(bos, "sendMarketData");
	            m_ser.serialize(bos, "", marketData);
	        ...
	        try {
	        	...
	        	if (tresponse != null && tresponse.getPayload() != null) {
	        		...
	        		if (retCode == 0) { // Function execution was OK.
						MarketData ret = m_ser.deserialize(bis, ""	, MarketData.class);
						return ret;
		            }
	...
	public QuoteRequest sendQuoteRequest(/*in*/ QuoteRequest quoteRequest) {
		if (m_ser != null && m_transport != null) {
			...
			try {
	            ...
	            m_ser.serializeService(bos, "benchmark");
	            m_ser.serializeOperation(bos, "sendQuoteRequest");
	            m_ser.serialize(bos, "", quoteRequest);
			} catch (IOException ex) {
				throw new RuntimeException(ex);
			}
			trequest.setPayload(bos.getByteBuffer());
	        ...
	        try {
	        	...
	        	if (tresponse != null && tresponse.getPayload() != null) {
	        		...
	        		int retCode = m_ser.deserializeUI32(bis, "");
	        		if (retCode == 0) { // Function execution was OK.
						QuoteRequest ret = m_ser.deserialize(bis, ""	, QuoteRequest.class);
						return ret;
		            }
	...
	@Override
	public void sendMarketData(/*in*/ MarketData marketData, final AsyncCallback<MarketData> callback) {
		...
		if (m_ser != null && m_transport != null) {
			...
			Futures.addCallback(dispatcher, new FutureCallback<TransportMessage> () {
	                ...
	                public void onSuccess(TransportMessage result) {
	                    benchmarkProcess.sendMarketData_processAsync(result, m_ser, callback);
	                }
	...
	@Override
	public void sendQuoteRequest(/*in*/ QuoteRequest quoteRequest, final AsyncCallback<QuoteRequest> callback) {
		...
		if (m_ser != null && m_transport != null) {
			...
			Futures.addCallback(dispatcher, new FutureCallback<TransportMessage> () {
	                ...
	                @Override
	                public void onSuccess(TransportMessage result) {
	                    benchmarkProcess.sendQuoteRequest_processAsync(result, m_ser, callback);
	                }
