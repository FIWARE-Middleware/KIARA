...
public class CharSwitchUnion implements Serializable {
	...
	public CharSwitchUnion() {
		this.intVal = 0;
		this.stringVal = "";
		this.floatVal = (float) 0.0;
	}
	
	public void _d(char discriminator) {
	...
	public boolean equals(Object other) {
		...
		if (other instanceof CharSwitchUnion) {
		
			switch(this.m_d) {
		
				case '1':
				case '2':
					comparison = comparison && (this.intVal == ((CharSwitchUnion) other).intVal);
					break;

				case '3':
					comparison = comparison && (this.stringVal.compareTo(((CharSwitchUnion) other).stringVal) == 0);
					break;

				default:
					comparison = comparison && (this.floatVal == ((CharSwitchUnion) other).floatVal);
					break;
	...
	/*
	 * This method serializes a CharSwitchUnion.
	 *
	...
	/*
	 * This method deserializes a CharSwitchUnion.
	 *
