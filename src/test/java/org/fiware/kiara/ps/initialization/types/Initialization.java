 ...
 *
 */
public class Initialization implements KeyedType, Serializable {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof Initialization) {
            ...
            comparison = comparison && (this.innerLongAtt == ((Initialization) other).innerLongAtt);

            comparison = comparison && (this.innerStringAtt.compareTo(((Initialization) other).innerStringAtt) == 0);
    ...
    public void copy(Initialization other) {
